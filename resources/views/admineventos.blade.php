...
<div class="container">
    <div class="row justify-content-md-center align-items-center vh-100">
        <div class="col-12 col-md-5 bg-white shadow p-4">
            ...
            <form method="POST" action="{{ route('guardardatoseventos') }}" enctype="multipart/form-data">
                @csrf
                <h1 class="text-center" style="color:#545859; font-size: 40px;">Agregar nuevo evento</h1>
                <br>
                <div class="form-group col-md-12">
                    <label for="photoUser" class="font-label">Foto </label><br>
                    <input type="file" id="foto" name="foto" class="input--style-4">
                </div>
                <div class="form-group">
                    <label class="form-label">Título del Evento:</label>
                    <input style="border-radius: 10px !important;" type="text" name="titulo" class="form-control" required>
                </div>
                <div class="form-group">
                ...
                <div class="form-group">
                    ...
                    <input style="border-radius: 10px !important;" type="date" name="fecha" class="form-control" required>
                </div>
                <div class="form-group">
                    <label class="form-label">Ubicación:</label>
                    <input style="border-radius: 10px !important;" type="text" name="ubicacion" class="form-control">
                </div>
                <div class="form-group">
                    <label class="form-label">Enlace de Registro (Opcional):</label>
                    <input style="border-radius: 10px !important;" type="url" name="link" class="form-control">
                </div>
                <div class="col text-center">
                    <button type="submit" class="btn btn-lg" style="border: 2px solid #545859; background-color: transparent; color: #545859; border-radius: 15px !important; padding: 10px 20px; transition: 0.3s;">
                        Agregar Evento
                    </button>
                </div>
            </form>
