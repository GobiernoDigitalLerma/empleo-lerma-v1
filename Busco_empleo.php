...
<head>
  <meta charset="UTF-8">
  <!-- CSRF Token -->
  <meta name="csrf-token" content="44TE5bPvrCucYoRgf5t1sVenzMaJ8KU7D2pC2IYb">
            ...
            <ul class="ml-auto p-0">
              ...
              <li><a class="btn" href="https://empleo.lerma.gob.mx/logout" onclick="event.preventDefault();
                ...
                <form id="logout-form" action="https://empleo.lerma.gob.mx/logout" method="POST" style="display: none;">
                  <input type="hidden" name="_token" value="44TE5bPvrCucYoRgf5t1sVenzMaJ8KU7D2pC2IYb">                </form>
              </li>
                            <li class="facebook">
